...
public class Drug {
    ...
    public Drug(long id, String drugName, double drugContent, int quantity, String dosageForm, String usage, String dosagePerDay, int totalDosage5Days, double pricePerPill, String productionDate, String expirationDate, String note) {
        this.id = id;

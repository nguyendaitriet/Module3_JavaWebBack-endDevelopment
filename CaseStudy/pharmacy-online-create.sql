...
ALTER TABLE `pharmacy_online`.`drug` 
RENAME TO  `pharmacy_online`.`drugs` ;
ALTER TABLE `pharmacy_online`.`order` 
RENAME TO  `pharmacy_online`.`orders` ;
ALTER TABLE `pharmacy_online`.`order_item` 
RENAME TO  `pharmacy_online`.`order_items` ;   
ALTER TABLE `pharmacy_online`.`user` 
RENAME TO  `pharmacy_online`.`users` ;
